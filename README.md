...
| `Ctrl-C` | Clear the composer. Press twice within 2 seconds on an empty composer to leave the switcher. |
| `Ctrl-D` twice / `Ctrl-Q` | Leave the switcher. Every job keeps running. |
